...
class CC_DLL Quick_x_cclabelchangePlayer : public CCObject
{
public:
...
private:
    static Quick_x_cclabelchangePlayer *s_sharedInstance;
    static Quick_x_cclabelchangePlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    Quick_x_cclabelchangePlayer(void);
